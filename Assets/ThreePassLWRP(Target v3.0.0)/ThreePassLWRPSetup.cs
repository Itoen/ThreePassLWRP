...
namespace ThreePassLWRP
{
    public class ThreePassLWRPSetup : IRendererSetup
    {
        ...
        private ThreePassLWRPRenderTransparent2ndPass m_RenderTransparentForward2ndPass;
        private ThreePassLWRPRenderTransparent3rdPass m_RenderTransparentForward3rdPass;
        ...
        private void Init (LightweightForwardRenderer renderer)
        {
            ...
            m_RenderOpaqueForward2ndPass = new ThreePassRenderOpaque2ndPass(renderer);
            m_RenderOpaqueForward3rdPass = new ThreePassRenderOpaque3rdPass(renderer);
            ...
            m_RenderTransparentForward2ndPass = new ThreePassLWRPRenderTransparent2ndPass(renderer);
            m_RenderTransparentForward3rdPass = new ThreePassLWRPRenderTransparent3rdPass(renderer);
            ...
            ref CullResults cullResults, ref RenderingData renderingData)
        {
            ...
            m_RenderOpaqueForward2ndPass.Setup(baseDescriptor, colorHandle, depthHandle, LightweightForwardRenderer.GetCameraClearFlag(camera), camera.backgroundColor, rendererConfiguration, dynamicBatching);
            renderer.EnqueuePass(m_RenderOpaqueForward2ndPass);
            m_RenderOpaqueForward3rdPass.Setup(baseDescriptor, colorHandle, depthHandle, LightweightForwardRenderer.GetCameraClearFlag(camera), camera.backgroundColor, rendererConfiguration, dynamicBatching);
            ...
            m_RenderTransparentForward2ndPass.Setup(baseDescriptor, colorHandle, depthHandle, ClearFlag.None, camera.backgroundColor, rendererConfiguration, dynamicBatching);
            renderer.EnqueuePass(m_RenderTransparentForward2ndPass);
            m_RenderTransparentForward3rdPass.Setup(baseDescriptor, colorHandle, depthHandle, ClearFlag.None, camera.backgroundColor, rendererConfiguration, dynamicBatching);
