...
{
    public class ThreePassLWRPSetup : IRendererSetup
    {
        ...
        private ThreePassRenderOpaque2ndPass m_RenderOpaqueForward2ndPass;
        private ThreePassRenderOpaque3rdPass m_RenderOpaqueForward3rdPass;
        private OpaquePostProcessPass m_OpaquePostProcessPass;
        private DrawSkyboxPass m_DrawSkyboxPass;
        private CopyDepthPass m_CopyDepthPass;
        private CopyColorPass m_CopyColorPass;
        private RenderTransparentForwardPass m_RenderTransparentForwardPass;
        private ThreePassRenderTransparent2ndPass m_RenderTransparentForward2ndPass;
        private ThreePassRenderTransparent3rdPass m_RenderTransparentForward3rdPass;
        ...
        private void Init ()
        {
            ...
            m_RenderOpaqueForward2ndPass = new ThreePassRenderOpaque2ndPass();
            m_RenderOpaqueForward3rdPass = new ThreePassRenderOpaque3rdPass();
            ...
            m_RenderTransparentForward2ndPass = new ThreePassRenderTransparent2ndPass();
            m_RenderTransparentForward3rdPass = new ThreePassRenderTransparent3rdPass();
        ...
        public void Setup (ScriptableRenderer renderer, ref RenderingData renderingData)
        {
            ...
            if (requiresDepthPrepass)
            {
                ...
                {
                    var fieldInfo = m_DepthOnlyPass.GetType().GetField("descriptor", BindingFlags.NonPublic | BindingFlags.Instance);
                    var descriptor = (RenderTextureDescriptor)fieldInfo.GetValue(m_DepthOnlyPass);
                    renderer.EnqueuePass(pass.GetPassToEnqueue(descriptor, DepthTexture));
                }
            }
            ...
            m_RenderOpaqueForward2ndPass.Setup(baseDescriptor, colorHandle, depthHandle, ClearFlag.None, camera.backgroundColor, rendererConfiguration);
            renderer.EnqueuePass(m_RenderOpaqueForward2ndPass);
            m_RenderOpaqueForward3rdPass.Setup(baseDescriptor, colorHandle, depthHandle, ClearFlag.None, camera.backgroundColor, rendererConfiguration);
            renderer.EnqueuePass(m_RenderOpaqueForward3rdPass);
            ...
            m_RenderTransparentForward2ndPass.Setup(baseDescriptor, colorHandle, depthHandle, ClearFlag.None, Color.clear, rendererConfiguration);
            renderer.EnqueuePass(m_RenderTransparentForward2ndPass);
            m_RenderTransparentForward3rdPass.Setup(baseDescriptor, colorHandle, depthHandle, ClearFlag.None, Color.clear, rendererConfiguration);
            renderer.EnqueuePass(m_RenderTransparentForward3rdPass);
