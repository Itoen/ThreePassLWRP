...
{
    public abstract class ThreePassLWRPForward3rdPass : ScriptableRenderPass
    {
        ...
        protected ThreePassLWRPForward3rdPass (LightweightForwardRenderer renderer) : base(renderer)
        {
            ...
            RegisterShaderPassName("LightweightForward3rd");
        }
