...
{
    public class ThreePassRenderOpaque3rdPass : ThreePassLWRPForward3rdPass
    {

        const string k_RenderOpaquesTag = "Render Opaques";

        public ThreePassRenderOpaque3rdPass (LightweightForwardRenderer renderer) : base(renderer)
        { }
